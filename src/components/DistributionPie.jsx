...
function CustomTooltip({ active, payload }) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-3 text-xs shadow-soft dark:border-slate-800 dark:bg-slate-950">
      ...
      <div className="mt-2 text-slate-600 dark:text-slate-300">{formatCurrencyMXN(row.inversion)}</div>
...
export default function DistributionPie({ data }) {
  return (
    <Card title="Distribución de inversión por canal" right="% de inversión">
